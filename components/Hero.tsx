    ...
    <section className="h-screen flex items-center justify-center pt-16 sm:pt-20 pb-4 sm:pb-6 px-4 sm:px-6 section-level-1 hero-shadow relative z-0 overflow-hidden">
      <div className="container mx-auto max-w-5xl text-center relative z-10 flex flex-col items-center justify-center h-full">
        <motion.div
          ...
          className="mb-3 sm:mb-4 md:mb-5 relative w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 lg:w-56 lg:h-56 xl:w-60 xl:h-60 mx-auto flex-shrink-0"
        >
        ...
        >
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-6xl xl:text-6xl font-bold mb-2 sm:mb-2 md:mb-3 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 pb-1 leading-tight">
            Jacky Chen
          </h1>
          <h2 className="text-sm sm:text-base md:text-lg lg:text-3xl xl:text-3xl font-semibold text-gray-800 dark:text-gray-200 mb-2 sm:mb-2 md:mb-3 px-2">
        ...
        <motion.p
          ...
          className="text-xs sm:text-sm md:text-base lg:text-xl text-gray-600 dark:text-gray-300 mb-3 sm:mb-4 md:mb-6 max-w-3xl mx-auto px-4 leading-relaxed flex-shrink-0"
        >
        ...
        >
          <a 
            href="#experience"
            className="w-full sm:w-auto px-4 sm:px-5 md:px-8 lg:px-10 py-1.5 sm:py-2 md:py-3 lg:py-3.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-blue-500/30 hover:-translate-y-0.5 text-xs sm:text-sm md:text-lg lg:text-lg"
          >
            View Work Experience
          </a>
          <a 
            href="#contact"
            className="w-full sm:w-auto px-4 sm:px-5 md:px-8 lg:px-10 py-1.5 sm:py-2 md:py-3 lg:py-3.5 border-2 border-gray-300 dark:border-gray-700 rounded-full font-medium hover:bg-gray-50 dark:hover:bg-gray-900 hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-300 hover:-translate-y-0.5 text-xs sm:text-sm md:text-lg lg:text-lg"
          >
            Contact Me
          </a>
        </motion.div>
