...
export default function Hero() {
  return (
    <section id="hero" className="h-screen flex items-center justify-center pt-16 sm:pt-20 pb-4 sm:pb-6 px-4 sm:px-6 section-level-1 hero-shadow relative z-0 overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10 flex flex-col items-center justify-center h-full">
        ...
        >
          From hardware product engineering to technical program leadership, delivering complex systems end to end.
        </motion.p>
