    ...
    <section className="h-screen flex items-center justify-center pt-16 sm:pt-20 pb-4 sm:pb-6 px-4 sm:px-6 section-level-1 hero-shadow relative z-0 overflow-hidden">
      <div className="container mx-auto max-w-5xl text-center relative z-10 flex flex-col items-center justify-center h-full">
        <motion.div
          ...
          className="mb-4 sm:mb-5 md:mb-6 relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 mx-auto flex-shrink-0"
        >
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 sm:mb-3 md:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 pb-1 leading-tight">
            Jacky Chen
          </h1>
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-gray-800 dark:text-gray-200 mb-2 sm:mb-3 md:mb-4 px-2">
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 md:mb-8 max-w-3xl mx-auto px-4 leading-relaxed flex-shrink-0"
        >
