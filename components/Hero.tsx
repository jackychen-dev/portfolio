    ...
    <section className="h-screen flex items-center justify-center pt-16 sm:pt-20 pb-4 sm:pb-6 px-4 sm:px-6 section-level-1 hero-shadow relative z-0 overflow-hidden">
      <div className="container mx-auto max-w-5xl text-center relative z-10 flex flex-col items-center justify-center h-full">
        <motion.div
          ...
          className="mb-4 sm:mb-5 md:mb-6 lg:mb-8 relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-64 lg:h-64 xl:w-72 xl:h-72 mx-auto flex-shrink-0"
        >
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-2 sm:mb-3 md:mb-4 lg:mb-5 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 pb-1 leading-tight">
            Jacky Chen
          </h1>
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-semibold text-gray-800 dark:text-gray-200 mb-2 sm:mb-3 md:mb-4 lg:mb-5 px-2">
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-2xl text-gray-600 dark:text-gray-300 mb-4 sm:mb-6 md:mb-8 lg:mb-10 max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto px-4 leading-relaxed flex-shrink-0"
        >
        ...
        >
          <a 
            href="#experience"
            className="w-full sm:w-auto px-6 sm:px-8 lg:px-10 xl:px-12 py-2.5 sm:py-3 lg:py-4 xl:py-5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-full font-medium hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-blue-500/30 hover:-translate-y-0.5 text-base sm:text-lg lg:text-xl xl:text-2xl"
          >
            View Work Experience
          </a>
          <a 
            href="#contact"
            className="w-full sm:w-auto px-6 sm:px-8 lg:px-10 xl:px-12 py-2.5 sm:py-3 lg:py-4 xl:py-5 border-2 border-gray-300 dark:border-gray-700 rounded-full font-medium hover:bg-gray-50 dark:hover:bg-gray-900 hover:border-gray-400 dark:hover:border-gray-600 transition-all duration-300 hover:-translate-y-0.5 text-base sm:text-lg lg:text-xl xl:text-2xl"
          >
            Contact Me
          </a>
        </motion.div>
